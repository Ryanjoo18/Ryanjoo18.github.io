...
\resumeItemListStart
\resumeItemPaper{}
%\resumeItemPaper{Acquired foundational knowledge of dietetics profession and infection control protocols during a comprehensive hospital introduction.}
%\resumeItemPaper{Shadowed dieticians in inpatient/outpatient settings, observing 15 tube feeding and nutritional support cases, enhancing understanding of tailored patient care.}
%\resumeItemPaper{Explored therapeutic diets for various medical conditions, contributing to the development of personalised nutritional plans.}
%\resumeItemPaper{Conducted hospital kitchen tour, observing meal plating procedures, ensuring adherence to dietary guidelines.}
%\resumeItemPaper{Assisted in nutritional supplement administration, supporting patient treatment plans.}
\resumeItemListEnd
...
%{Website}{2024}
%\resumeItemListStart
%\resumeItemPaper{The link to the website is \url{}. The source code can be found on my GitHub.}
%\resumeItemListEnd
...
Utilised data from Sentinel-2 satellite to identify hotspots and analyse surrounding areas in Sumatra, Indonesia. Hosted on Google Earth Engine.

\resumeSubheading
{\href{https://ryanjoo18.github.io/web/}{Personal website}}{}
...
% Source code: https://gist.github.com/FedericoTartarini/02e61c53c6112b122bc45be650d80d92

% Try to learn SQL, R, use JetBrains IDEs